...
<div class="button-section" style="text-align: center; margin-top: 20px;">
    <a href="<?php echo htmlspecialchars($qrCodeBase64); ?>" download="<?php echo htmlspecialchars($unique_filename); ?>">
    ...
    <div class="amount text-center mobile-only" style="margin: 15px 0;">
    <p class="pay_mode_label">Pay using any UPi Apps</p>
    </div>
  
    <div class="apps_container mobile-only">
        <a class="paybyupiappsbtn" href="#" onclick="onBuyClicked();"><img src="https://pay.imb.org.in/checkout/images/gpay.png" alt="Google Pay" /></a>
    </div>
    <div class="apps_container mobile-only">
        <a class="paybyupiappsbtn" href="<?=$paytmintent?>"><img src="https://pay.imb.org.in/checkout/images/paytm.png" alt="Paytm" /></a>
    </div>
    ...
    <script>
        ...
        function checkPaymentStatus() {
            $.ajax({
                ...
                data: 'byte_order_status=<?php echo $cxrkalwaremark ?>&order_id=<?php echo $order_id ?>',
